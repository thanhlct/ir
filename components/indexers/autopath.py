...
def __dirinfo(part):
    ...
    while head:
        ...
        if tail == part:
            checkfile = os.path.join(partdir, os.pardir, project_directory, '__init__.py')
...
def __clone():
    ...
    if not this_dir.endswith(join(project_directory,'tools')):
...
pypydir, this_dir = __dirinfo(project_directory)
